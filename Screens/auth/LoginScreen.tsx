 ...
 * Halaman login dan registrasi untuk pengguna/pasien klinik.
 */
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <Text style={styles.tagline}>Portal Kesehatan Profesional</Text>
          </View>

          <View style={styles.card}>
            <View style={styles.tabContainer}>
              <TouchableOpacity style={[styles.tab, isLoginMode && styles.activeTab]} onPress={() => setIsLoginMode(true)}>
                <Text style={[styles.tabText, isLoginMode && styles.activeTabText]}>Masuk Pasien</Text>
              </TouchableOpacity>
            ...
            <View style={styles.formContainer}>
              ...
              <TouchableOpacity style={styles.primaryButton} onPress={handleAuth} disabled={loading}>
                {loading ? (
                  ...
                  <Text style={styles.buttonText}>{isLoginMode ? 'Akses Portal' : 'Daftar Sekarang'}</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.footer}>
            ...
            >
              <Ionicons name="arrow-back" size={16} color={COLORS.userPrimary} style={styles.footerIconBack} />
...
const styles = StyleSheet.create({
  ...
  activeTabText: { color: COLORS.userPrimary, fontWeight: '700' },
  ...
  primaryButton: {
    backgroundColor: COLORS.userPrimary, paddingVertical: SPACING.lg, borderRadius: RADIUS.md,
  ...
  switchRoleText: { color: COLORS.userPrimary, fontWeight: '700', fontSize: 14 },
